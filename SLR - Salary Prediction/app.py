...
model = pickle.load(open(r"C:\Users\PC World\OneDrive\Documents\Practice Machine Learning\Regression model (SLR)\SLR - Salary Prediction\linear_regression_model.pkl", 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience. Built by Vaishnavi")
